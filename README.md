...
Integração a [Rede][url-method]

## Vídeo(s) Demonstrativo

https://www.useloom.com/share/9432a0a5962941ddbaea895cfcb46077
...
### Para instalar o módulo execute o comando a seguir no terminal do seu servidor no diretório do seu projeto
	...
	composer require mozgbrasil/magento-rede-php_71:dev-master
...
### Para [desinstalar][uninstall-mods] o módulo execute o comando a seguir no terminal do seu servidor no diretório do seu projeto
	...
	composer remove mozgbrasil/magento-rede-php_71
...
Para configurar o método de pagamento, acesse no backend em:
	...
	STORES -> Configuration -> Sales/Payment Methods -> Rede (powered by MOZG)

Você terá os campos a seguir

### Rede API V2 - Configurações Padrão
...
https://cadastrosandbox.rede.com.br/
...
A informação deve ser fornecido pela Rede
...
https://www.userede.com.br/desenvolvedores/pt/cadastro
...
Crie sua loja em "minha loja" para começar a utilizar o playground

Onde será fornecido o seu PV e Token

Configure no método no Magento o seu PV e Token

Efetue uma transação e testes usando os seguintes cartões de testes
...
https://www.userede.com.br/desenvolvedores/pt/produto/e-Rede#suporte

### Efetuando uma simulação

A seguir podemos efetuar a simulação

https://demomagento.cerebrum.com.br/testes.html

Os retornos das transações é aleatório, sendo necessário efetuar algumas tentativas

#### Simulação de transação

Filiação e Token: __PV__:__TOKEN__
Base64: __Base64__

    curl --request POST https://api.userede.com.br/desenvolvedores/v1/transactions --header 'Content-Type: application/json' --header 'Authorization: Basic __Base64__' --data '{
	    "capture": false,
	    "reference": "pedido123",
	    "amount": 2099,
...
/skin/frontend/<TEMPLATE>/default/images/mozg_rede

### Dados de contato - Rede
...
[![Latest Stable Version](https://poser.pugx.org/mozgbrasil/magento-rede-php_71/v/stable)](https://packagist.org/packages/mozgbrasil/magento-rede-php_71)
[![Total Downloads](https://poser.pugx.org/mozgbrasil/magento-rede-php_71/downloads)](https://packagist.org/packages/mozgbrasil/magento-rede-php_71)
[![Latest Unstable Version](https://poser.pugx.org/mozgbrasil/magento-rede-php_71/v/unstable)](https://packagist.org/packages/mozgbrasil/magento-rede-php_71)
[![License](https://poser.pugx.org/mozgbrasil/magento-rede-php_71/license)](https://packagist.org/packages/mozgbrasil/magento-rede-php_71)
[![Monthly Downloads](https://poser.pugx.org/mozgbrasil/magento-rede-php_71/d/monthly)](https://packagist.org/packages/mozgbrasil/magento-rede-php_71)
[![Daily Downloads](https://poser.pugx.org/mozgbrasil/magento-rede-php_71/d/daily)](https://packagist.org/packages/mozgbrasil/magento-rede-php_71)
[![Reference Status](https://www.versioneye.com/php/mozgbrasil:magento-rede-php_71/reference_badge.svg?style=flat-square)](https://www.versioneye.com/php/mozgbrasil:magento-rede-php_71/references)
[![Dependency Status](https://www.versioneye.com/php/mozgbrasil:magento-rede-php_71/1.0.0/badge?style=flat-square)](https://www.versioneye.com/php/mozgbrasil:magento-rede-php_71/1.0.0)
